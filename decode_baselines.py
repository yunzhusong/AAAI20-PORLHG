...
from data.batcher import tokenize_decode # tokenize function for decode 

from decoding import Abstractor, Extractor, DecodeDataset
from decoding import make_html_safe


MAX_ABS_NUM = 1  # need to set max sentences to extract for non-RL extractor
    ...
    with torch.no_grad():
        for i_debug, batch_data in enumerate(loader):
            ...
            for data in batch_data:
                ...
                ext = extractor(raw_art_sents, topic)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_ext', type=int, action='store', default=1,
