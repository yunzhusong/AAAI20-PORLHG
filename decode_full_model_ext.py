...
from data.batcher import tokenize_decode

from decoding_ext import Abstractor, RLExtractor, DecodeDataset, BeamAbstractor
from decoding_ext import make_html_safe
        ...
        for i_debug, batch_data in enumerate(loader):
            ...
            for data in batch_data:
                ...
                if not ext:
                    ...
                    ext = list(range(1))[:len(raw_art_sents)]  # YUNZHU change from 5 to 1
